            ...
            >
                ...
                >
                    ...
                    <ng-container *ngIf="!disabled">
                        ...
                        <span *ngIf="removeTokenIconTemplate" class="p-chips-token-icon pi pi-times" (click)="removeItem($event, i)" [attr.data-pc-section]="'removeTokenIcon'" [attr.aria-hidden]="true">
